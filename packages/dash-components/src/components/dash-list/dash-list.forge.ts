...
const template = (args, updateArg) => {
  ...
  return html`<dash-list style="width: 10rem;" max-items=${args.maxItems} selection-mode=${args.selectionMode} disable-deselect=${args.disableDeselect} scale=${args.scale}>
