...
import { defineCustomElements } from '@didyoumeantoast/dash-components/loader';
...
export const DashNavBar = /*@__PURE__*/createReactComponent<JSX.DashNavBar, HTMLDashNavBarElement>('dash-nav-bar');
